...
@bg2_40123202_cdw14.route('/fourgear', defaults={'n1':15,'n2':20,'n3':18,'n4':10})
@bg2_40123202_cdw14.route('/fourgear/<n1>/<n2>/<n3>/<n4>')
...
spur(cx+pr1+2*pr2+2*pr3+pr4, cy, m, n4, pa, 180-180/n4+(180-180/n3+(180-180/n2)*n2/n3)*n3/n4)
</script>
'''
