...
b40123214_1 = Blueprint('b40123214_1', __name__, url_prefix='/b40123214_1', template_folder='templates')

@b40123214_1.route('/fivegear', defaults={'n1':15,'n2':20,'n3':18,'n4':20, 'n5':35})
@b40123214_1.route('/fivegear/<n1>/<n2>/<n3>/<n4>/<n5>')
